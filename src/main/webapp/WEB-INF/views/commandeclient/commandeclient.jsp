	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header"><fmt:message code="common.client.comande" /></h1>
					</div>
					<!-- /.col-lg-12 -->
				</div>
				<div class="row">
                ...
                <div class="col-lg-12">
					...
					<fmt:message code="common.client.liste"/>
                        </div>
                        <!-- /.panel-heading -->
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    <tr>
                                        ...
                                        <th><fmt:message code="common.client.commade"/></th>
				...
				<!-- /.row -->
				<!-- /.detaile de la commande -->
				<div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
					<fmt:message code="common.client.details"/>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <td>
                                        <c:url value ="/commandeclient/modifier/${cde.getIdCommandeClient()}" var="modifier"/>
                                   <a href="${modifier}"><i class="fa fa-edit"></i></a>
                                   &nbsp;|&nbsp;
                                   
                                   <a href="javascript:void(0);" data-toggle="modal" data-target="#modalCommandeClient${cde.getIdCommandeClient() }"><i class="fa fa-trash-o"></i></a>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel"><fmt:message code="common.confirmationSuppression"/></h4>
                                        </div>
                                        <div class="modal-body">
										<fmt:message code="common.msgSuppression"/>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-default" data-dismiss="modal"><fmt:message code="common.fermer"/></button>
                                            <c:url value="/commandeclient/supprimer/${cde.getIdCommandeClient()}" var="UrlSuppression"/>
                                            <a href="${UrlSuppression}"  class="btn btn-danger"><i class="fa fa-trash-o"></i>&nbsp;<fmt:message code="common.SauvegarderLesModifications"/></a>
                                        </div>
                                    </div>
                                    <!-- /.modal-content -->
                                </div>
